              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 10),
                    _buildTextField(_specializationController, 'التخصص', Icons.school),
                    const SizedBox(height: 16),
                    _buildTextField(_salaryController, 'الأجر', Icons.monetization_on, keyboardType: TextInputType.number),
                    const SizedBox(height: 16),
